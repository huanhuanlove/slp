    ...
    <section style="background-image:url(images/banner-news.jpg)" class="banner text-center full_bg">
        <div class="banner-mask">
            <div class="container">
                ...
                <p><a href="#">赛利普</a> >   <a href="project.htm">${requestScope.catename}</a> >  查看内容</p>
            </div>
        </div>
    </section>
    <main class="main">
                ...
                <div class="row">
                    <article class="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-lg-offset-1 col-md-offset-1">
                        <header class="text-center">
                            <h2 class="title">${requestScope.news.newsTitle }</h2>
                            <div class="info">
                                <small class="date">时间 ${requestScope.news.newsDate }</small><small class="hits">
