            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/news/UpdateNewsServlet"  enctype="multipart/form-data">
                            <input type="hidden" name="bid" value="${requestScope.news.id }"/>
                           	<input type="hidden" name="yimg" value="${requestScope.news.newsImg }"/>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="zxName" name="zxName" value="${requestScope.news.newsTitle }"/>
                                            </div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control datepicker" value="${requestScope.news.newsDate }" name="zxDate" >
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            ...
                                            <c:forEach items="${requestScope.al }" var="news">
                                            	<c:choose>
                                            		<c:when test="${news.id==requestScope.news.cateId }">
                                            			<option value="${news.id }" selected="selected">${news.cateName }</option>
                                            		</c:when>
                                            		<c:otherwise>
                                            		   <option value="${news.id }">${news.cateName }</option>
                                            		</c:otherwise>
                                            	</c:choose>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/upload/${requestScope.news.newsImg }" id="img0" width="240" height="100" >
                                            </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div id="summernote"><p>${requestScope.news.newsContent }</p></div>
