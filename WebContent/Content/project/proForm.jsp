            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/project/AddProject"  enctype="multipart/form-data">
                                ...
                                <div class="panel-body form-group-separated">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="mydate" class="form-control datepicker"  name="zxDate">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            ...
                                            <c:forEach items="${requestScope.al }" var="pro">
