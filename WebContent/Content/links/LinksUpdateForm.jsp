            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/links/UpdateLinksServlet"  enctype="multipart/form-data">
                           <input type="hidden" name="bid" value="${requestScope.links.id }">
                            	<input type="hidden" name="yimg" value="${requestScope.links.linkImg }"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="linksName" name="linksName" value="${requestScope.links.name }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="linksUrl" name="linksUrl" value="${requestScope.links.url }"/>
                                            </div>
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/upload/${requestScope.links.linkImg }" id="img0" width="240" height="100" >
                                            </div>
