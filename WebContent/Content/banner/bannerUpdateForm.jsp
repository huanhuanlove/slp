     ...
     <li class="xn-icon-button pull-right">
        <a href="#" class="mb-control" data-box="#mb-signout"><span class="fa fa-sign-out"></span></a>
            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/banner/bannerUpd_inn"  enctype="multipart/form-data">
                           <input type="hidden" name="bid" value="${requestScope.bannerData.id }" >
                           <!-- 判断是否已有此图片 -->
                           <input type="hidden" name="yimg" value="${requestScope.bannerData.bannerImg }"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="bannerName" name="bannerName" value="${requestScope.bannerData.name }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="urlImage" name="urlImage" value="${requestScope.bannerData.url }"/>
                                            </div>
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/bannerImg/${requestScope.bannerData.bannerImg }" id="img0" width="240" height="100" >
                                            </div>
