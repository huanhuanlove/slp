            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/sizeInfo/sizeInfoUpd_inn"  enctype="multipart/form-data">
                           	<input type="hidden" name="bid" value="${requestScope.sizeList.id }"/>
                           	<input type="hidden" name="yimg" value="${requestScope.sizeList.infoImg }"/>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="infoName" name="infoName" value="${requestScope.sizeList.name }"/>
                                            </div>
                                            <span class="help-block" style="display: none;color: red" id="infoName_lable">请输入站点名称！</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/newsImgs/${requestScope.sizeList.infoImg }" id="img0" width="240" height="100" >
                                            </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div id="summernote"><p id="pdata">${requestScope.sizeList.content }</p></div>
