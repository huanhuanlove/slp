            ...
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" onsubmit="return checkdata()" method="post" action="${pageContext.request.contextPath}/server/UpdateServerServlet"  enctype="multipart/form-data">
                                <input type="hidden" name="bid" value="${requestScope.server.id }">
                            	<input type="hidden" name="yimg" value="${requestScope.server.serviceImg }"/>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="sName" name="sName" value="${requestScope.server.serviceName }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" id="sTitle" name="sTitle" value="${requestScope.server.serviceTitle }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                               ...
                                               <input type="file" class="form-control" value="浏览图片" style="display: none" id="searchImage" name="fileImage"/>
                                           		  ...
                                           		  <br/><img src="${pageContext.request.contextPath}/upload/${requestScope.server.serviceImg }" id="img0" width="240" height="100" >
                                            </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div id="summernote"><p>${requestScope.server.serviceContent }</p></div>
