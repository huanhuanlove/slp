var pro_name = '/SLP_admin'
var pro_name2 = '/SLP_admin/Content/'
var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="'+pro_name2+'css/theme-default.css"><img src="'+pro_name+'/Content/img/themes/default.jpg"/></a>'            
            +'<a href="#" data-theme="'+pro_name2+'css/theme-forest.css"><img src="'+pro_name+'/Content/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="'+pro_name2+'css/theme-dark.css"><img src="'+pro_name+'/Content/img/themes/dark.jpg"/></a>'                        
            +'<a href="#" data-theme="'+pro_name2+'css/theme-night.css"><img src="'+pro_name+'/Content/img/themes/night.jpg"/></a>'            
            +'<a href="#" data-theme="'+pro_name2+'css/theme-serenity.css"><img src="'+pro_name+'/Content/img/themes/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="'+pro_name2+'css/theme-default-head-light.css"><img src="'+pro_name+'/Content/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="'+pro_name2+'css/theme-forest-head-light.css"><img src="'+pro_name+'/Content/img/themes/forest-head-light.jpg"/></a>'    
            +'<a href="#" data-theme="'+pro_name2+'css/theme-dark-head-light.css"><img src="'+pro_name+'/Content/img/themes/dark-head-light.jpg"/></a>'            
            +'<a href="#" data-theme="'+pro_name2+'css/theme-night-head-light.css"><img src="'+pro_name+'/Content/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="'+pro_name2+'css/theme-serenity-head-light.css"><img src="'+pro_name+'/Content/img/themes/serenity-head-light.jpg"/></a>'
