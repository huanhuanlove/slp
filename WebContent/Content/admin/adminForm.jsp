    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">管理员信息${requestScope.user==null?'添加':'修改' }</li>
            </ul>
            <!-- END 面包屑 -->
            <!-- 页面内容 -->
            <div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" id="myfrom" action="${requestScope.user==null?'../../admin/adminAdd':'updAdmin_inn' }" onsubmit="return checkdata()">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>${requestScope.user==null?'添加':'修改' }管理员信息</strong> </h3>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="adminName" name="adminName" value="${requestScope.user.adminName }"/>
                                            </div>
                                            <span class="help-block" style="display: none;color: red" id="adminName_lable">管理员名称不能为空，并且长度不能小于3位！</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control" id="pwd" name="adminPwd" value="${requestScope.user.password }"/>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                <input type="password" class="form-control" id="pwd2" value="${requestScope.user.password }"/>
                                            </div>
